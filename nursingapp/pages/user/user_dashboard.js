...
export default function Profile() {
    ...
    return (
        <div>
            <img src="/wkucuplong.jpg" className={styles.logo}/>
            <h1 className={styles.centerText}>Document Submission Portal</h1>
            {session ? (
                <div>
                    <p className={styles.addressUser}>Welcome, {session.user.first_name}!</p>
                </div>
            ) : (
            ...
            <div className={styles.groupCards}>
                ...
                <h2 style={{marginLeft: "20%"}}>Completed</h2>
                    <div id="completed1" className={styles.cardL}><Link href="../view/viewdoc1" style={{textDecoration: "none", color: "black"}}>2022 COVID Care Volunteer Form WKU Feedback</Link></div>
                    <div id="completed2" className={styles.cardL}><Link href="../view/viewdoc2" style={{textDecoration: "none", color: "black"}}>Consent form Release of Information - Spring 2024</Link></div>
                    <div id="completed3" className={styles.cardL}><Link href="../view/viewdoc3" style={{textDecoration: "none", color: "black"}}>LPN to ASN Online Acceptance Form - Spring 2024</Link></div>
                ...
                <h2 style={{marginLeft: "41%"}}>Remaining</h2>
                    ...
                    <div id="remaining2" className={styles.card}><Link href="../document_pages/doc2" style={{textDecoration: "none", color: "black"}}>Consent form Release of Information - Spring 2024</Link></div>
                    <div id="remaining3" className={styles.card}><Link href="../document_pages/doc3" style={{textDecoration: "none", color: "black"}}>LPN to ASN Online Acceptance Form - Spring 2024</Link></div>
